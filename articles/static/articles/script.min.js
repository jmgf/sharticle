...
function addImage(imageSrc){var new_image=document.createElement("img");var IMAGE_PREFIX='/static/articles/';new_image.src=IMAGE_PREFIX+imageSrc;new_image.contentEditable='true';var new_image_caption=document.createElement("p");new_image_caption.contentEditable='true';new_image_caption.innerHTML='Image caption';new_image_caption.className='image-caption';document.getElementById("columns").appendChild(new_image);document.getElementById("columns").appendChild(new_image_caption);window.scrollTo(0,document.body.scrollHeight);new_image_caption.focus()}
...
document.getElementById(topic_id+"_loader").style.display='none';if(data.articles!=null){var user=data.author;var html='';data.articles.forEach(article=>{user_image_html='<span class="glyphicon glyphicon-user pull-left"></span>';var article_image_url=(article.image_path!=""?('/static/articles/'+article.image_path):"https://www.freeiconspng.com/uploads/no-image-icon-6.png")
html+=`
                        <div class="col-md-6" id="article_box_${ article.id }">
                            <div class="article-box">
                                <div class="row">
